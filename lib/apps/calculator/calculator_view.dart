            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  calcButton('DEL', Colors.white10, () => buttonPressed('DEL')),
                  calcButton('sin', Colors.white10, () => buttonPressed('sin')),
                  calcButton("cos", Colors.white10, () => buttonPressed('cos')),
                  calcButton("tan", Colors.white10, () => buttonPressed('tan')),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  calcButton(
                      'x^-1', Colors.white10, () => buttonPressed('^-1')),
                  calcButton('x^2', Colors.white10, () => buttonPressed('^2')),
                  calcButton('x^', Colors.white10, () => buttonPressed('^')),
                  calcButton("log", Colors.white10, () => buttonPressed('log')),
                  calcButton("ln", Colors.white10, () => buttonPressed('ln')),
                ],
              ),
              const SizedBox(height: 5),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  calcButton('π', Colors.white24, () => buttonPressed('π')),
...
//mainAxisAlignment: MainAxisAlignment.spaceAround
                    children: [
                      Row(
                        children: [
                          calcButton(
                              'e', Colors.white24, () => buttonPressed('e')),
                          SizedBox(
                      ...
                      Row(
                        ...
                        children: [
                          calcButton(
                              'C', Colors.white24, () => buttonPressed('T')),
                          SizedBox(
                              width: MediaQuery.of(context).size.width * 0.04),
                          calcButton(
